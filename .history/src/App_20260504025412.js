...
const firebaseConfig = {
  apiKey: "AIzaSyCzXE7_MnnNiKELtd2d_WQ1ipGgqAmRQrY",
  authDomain: "jifei-aa30f.firebaseapp.com",
  projectId: "jifei-aa30f",
  storageBucket: "jifei-aa30f.firebasestorage.app",
  messagingSenderId: "700310983514",
  appId: "1:700310983514:web:5d478ff21ff0f765dd9963",
  measurementId: "G-J7V1VMMYH8"
};
const isFirebaseConfigured = firebaseConfig && firebaseConfig.apiKey && firebaseConfig.authDomain && firebaseConfig.projectId;
let app = null;
let auth = null;
let db = null;
...
export default function App() {
  ...
  useEffect(() => {
    if (!isFirebaseConfigured) {
      setAlertMessage('Firebase 配置不完整，请检查 authDomain / apiKey / projectId');
      setIsLoading(false);
      return;
    }
    ...
    const initAuth = async () => {
      try {
        ...
        setAlertMessage('Firebase 认证失败，请检查 Firebase 配置和匿名登录是否已启用。');
        setIsLoading(false);
      }
    };
    initAuth();
