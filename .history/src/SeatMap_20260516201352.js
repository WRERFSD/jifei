              ...
              >
                {session ? (
                  <span className="text-[11px] text-center px-1 leading-tight">
                    {session.customerName || session.phoneTail}
                    <br />
                    <span className="text-[10px] text-white/80">{session.phoneTail}</span>
                  </span>
                ) : (
          ...
          >
            ...
            {selectedSession ? (
              <div className="space-y-2">
                ...
                <div className="font-medium text-stone-900">{selectedSession.customerName || selectedSession.seatNumber} / {selectedSession.seatNumber}</div>
