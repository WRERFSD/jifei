...
import { Clock, Play, CheckSquare, Coffee, DollarSign, AlertCircle, Timer, X, History, Search } from 'lucide-react';
...
export default function App() {
  ...
  const handleStart = (e) => {
    ...
    const newSession = {
      ...
      phoneTail: mainTail,
      groupMembers,
      startTime: Date.now() + prepTimeMinutes * 60 * 1000 + delayMinutes * 60 * 1000,
